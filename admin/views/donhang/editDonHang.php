                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ten_nguoi_nhan"
                                        value="<?= $donHang['ten_nguoi_nhan'] ?>" placeholder="Nhập tên danh mục" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="sdt_nguoi_nhan"
                                        value="<?= $donHang['sdt_nguoi_nhan'] ?>" placeholder="Nhập tên danh mục" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="email_nguoi_nhan"
                                        value="<?= $donHang['email_nguoi_nhan'] ?>" placeholder="Nhập tên danh mục" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="dia_chi_nguoi_nhan"
                                        value="<?= $donHang['dia_chi_nguoi_nhan'] ?>" placeholder="Nhập tên danh mục" disabled>
                                ...
                                <div class="form-group">
                                    <label>Ghi Chú</label>
                                    <textarea name="ghi_chu" id="" class="form-control" placeholder="Nhập mô tả" disabled><?= $donHang['ghi_chu'] ?> </textarea>
                                </div>
                                <hr>
                                <div class="form-group">
